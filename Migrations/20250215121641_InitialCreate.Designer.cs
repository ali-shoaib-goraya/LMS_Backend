...
namespace Dynamic_RBAMS.Migrations
{
    ...
    [Migration("20250215121641_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dynamic_RBAMS.Features.UserManagement.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Dynamic_RBAMS.Features.UserManagement.Faculty", b =>
                {
                    b.HasBaseType("Dynamic_RBAMS.Features.UserManagement.ApplicationUser");
            ...
            modelBuilder.Entity("Dynamic_RBAMS.Features.UserManagement.Student", b =>
                {
                    b.HasBaseType("Dynamic_RBAMS.Features.UserManagement.ApplicationUser");
            ...
            modelBuilder.Entity("Dynamic_RBAMS.Features.AuthenticationManagment.RefreshToken", b =>
                {
                    b.HasOne("Dynamic_RBAMS.Features.UserManagement.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Dynamic_RBAMS.Features.Common.Models.DepartmentFaculty", b =>
                {
                    ...
                    b.HasOne("Dynamic_RBAMS.Features.UserManagement.Faculty", "Faculty")
                        .WithMany("DepartmentFaculties")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Dynamic_RBAMS.Features.UserManagement.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Dynamic_RBAMS.Features.UserManagement.Faculty", b =>
                {
                    ...
                    b.HasOne("Dynamic_RBAMS.Features.UserManagement.ApplicationUser", null)
                        .WithOne()
                        .HasForeignKey("Dynamic_RBAMS.Features.UserManagement.Faculty", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Dynamic_RBAMS.Features.UserManagement.Student", b =>
                {
                    b.HasOne("Dynamic_RBAMS.Features.UserManagement.ApplicationUser", null)
                        .WithOne()
                        .HasForeignKey("Dynamic_RBAMS.Features.UserManagement.Student", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
